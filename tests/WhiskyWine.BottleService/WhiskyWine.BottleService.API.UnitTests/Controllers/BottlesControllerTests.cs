...
namespace WhiskyWine.BottleService.API.UnitTests.Controllers
{
    ...
    public class BottlesControllerTests
    {
        ...
        /// </summary>
        private Mock<IValidator<Bottle>> _mockValidator;
        ...
        public void Setup()
        {
            ...
            _mockValidator = new Mock<IValidator<Bottle>>();
        }
        ...
        public async Task GetBottleAsync_Returns404_WhenServiceReturnsNull()
        {
            ...
            var bottlesController = new BottlesController(_mockBottleService.Object, _mockValidator.Object);
