...
namespace WhiskyWine.BottleService.API.Controllers
{
    ...
    public class BottlesController : Controller
    {
        ...
        /// </summary>
        private readonly IValidator<Bottle> _bottleValidator;
        ...
        public BottlesController(IBottleService bottleService, IValidator<Bottle> bottleValidator)
        {
        ...
        public async Task<IActionResult> PostBottleAsync(Bottle bottle)
        {
            ...
            await _bottleValidator.ValidateAndThrowAsync(bottle);
